    ...
    >
      ...
      {post.stamp && (
        <aside className="article-addendum" aria-label="Author's note">
          ...
          <p>
            <strong>Written on paternity leave.</strong> New baby, strange hours, and — oddly —
            more time to build and write these up than usual. That's the stamp. Normal
            time-scarcity resumes shortly.
          </p>
        </aside>
      )}
