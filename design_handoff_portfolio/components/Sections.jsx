/* Projects + Resume/GitLog + Writing + Contact */
...
const CATEGORIES = [
  { id: 'all',        label: 'All projects',  filter: p => true },
                  ...
                  <div className="block">
                    ...
                    {p.href && (
                      <div style={{ marginTop: 20 }}>
                        <a href={p.href} target="_blank" rel="noopener" className="btn mono">Visit ↗</a>
                      </div>
                    )}
                  </div>
                  <div className="block">
...
function Resume() {
  const [mode, setMode] = useStateP('experience');
        ...
        <div className="contact-grid">
          <div>
            ...
            <div className="fact-list" style={{ marginTop: 0 }}>
              ...
              <div className="fact"><span>linkedin</span><a href="https://www.linkedin.com/in/chris-pachulski/" target="_blank" rel="noopener">in/chris-pachulski</a></div>
              <div className="fact"><span>github</span><a href="https://github.com/ChrisPachulski" target="_blank" rel="noopener">github.com/ChrisPachulski</a></div>
            </div>
          </div>
...
Object.assign(window, { Projects, Resume, Writing, Contact });
